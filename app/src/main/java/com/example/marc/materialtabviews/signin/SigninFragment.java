...
public class SigninFragment extends FragmentActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener {

    private static final String TAG = "SignInActivity";
    private static final int RC_SIGN_IN = 9001; // Wut
    ...
    public void onStart() {
        ...
        // Views
        mStatusTextView = (TextView) findViewById(R.id.successText);
